...
<script>
    ...
    export default {
        ...
        mounted() {
          this.$reveal('.reveal-left',true,'left');
          this.$reveal('.reveal-right',true,'right')
        },
        methods: {
